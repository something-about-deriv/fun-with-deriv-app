...
import { AccountTransfer } from '@deriv/cashier';
...
const AccountTransferModal = observer(
  ({ is_modal_open, toggleModal }: TAccountTransferModal) => {
    const {
      modules: {
        cashier: {
          account_transfer: {
    ...
    const modal_title = !is_transfer_confirm && (
      <Localize i18n_default_text={'Transfer funds to your accounts'} />
    );
