...
const PasswordMeter = ({
  ...
  const [feedback, setFeedback] = React.useState<TCustomFeedback>({
    warning: () => '',
    suggestions: '',
  });
    ...
    <React.Fragment>
      <div className="dc-password-meter__container">
        ...
        {typeof children === 'function'
          ? children({ has_warning: !!feedback?.warning })
          : children}
        ...
        <div
          className={classNames('dc-password-meter', {
            ...
            'dc-password-meter--strong':
              !has_error && input.length && score >= 3,
          })}
        ...
        {feedback?.warning && !has_error && (
          <Field
            ...
            message={`${
              custom_feedback_messages ? feedback.warning() : feedback.warning
            }`}
            type="error"
          />
        )}
