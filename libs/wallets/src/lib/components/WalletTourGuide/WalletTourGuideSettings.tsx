    ...
    <div {...tooltipProps} className="wallets-tour-guide__container">
      <div className="wallets-tour-guide__header">
        ...
        <CloseIcon
          ...
          onClick={
            skipProps.onClick as unknown as React.MouseEventHandler<SVGElement>
          }
        />
      </div>
      {
        <div className="wallets-tour-guide__content">
      ...
      <div className="wallets-tour-guide__footer">
        ...
        {continuous && (
          <WalletButton {...primaryProps} text={isLastStep ? 'Done' : 'Next'} />
        )}
...
export const getWalletIndexForTarget = (
  loginid?: string,
  wallets?: THooks.WalletAccountsList[]
) => {
