...
export const ToggleButtonGroup = ({
  ...
  const toggle_buttons = React.Children.map(children, (button) => {
    ...
    const { is_selected: button_is_selected, value: button_value } =
      button.props;
    const is_selected =
      button_is_selected === undefined
        ? isButtonSelected(value, button_value)
        : button_is_selected;
  ...
  return (
    <div
      data-testid="dt_toggle_button_group"
