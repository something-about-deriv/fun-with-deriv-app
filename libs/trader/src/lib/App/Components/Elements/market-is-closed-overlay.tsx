...
type TMarketIsClosedOverlay = {
  ...
  is_synthetics_trading_market_available: ReturnType<
    typeof useTraderStore
  >['is_synthetics_trading_market_available'];
  onClick: () => void;
  onMarketOpen: React.ComponentProps<
    typeof MarketCountdownTimer
  >['onMarketOpen'];
...
const MarketIsClosedOverlay = ({
  ...
  return (
    ...
    >
      <Text
        as="p"
        className="market-is-closed-overlay__main-heading"
        color="prominent"
        weight="bold"
      >
