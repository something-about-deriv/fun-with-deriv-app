...
import { PositionsCardLoader } from '../../../Components/Elements/ContentLoader';
...
import { useTraderStore } from '../../../../trader-providers';
...
type TPortfolioPosition = Pick<
  ...
  | 'profit_loss'
>;
type TPickPortfolioStore = Pick<
  TPortfolioStore,
  'onClickSell' | 'onClickCancel'
>;
...
type TPositionsModalCard = TPickPortfolioStore &
  TPortfolioPosition & {
    ...
    current_tick?: React.ComponentProps<
      typeof ProgressSliderMobile
    >['current_tick'];
    is_loading?: boolean;
  ...
  ({
      ...
      <React.Fragment>
        ...
        <div
          className={classNames(
            'positions-modal-card__grid',
            'positions-modal-card__grid-body'
          )}
        >
          <div
            className={classNames('positions-modal-card__grid-profit-payout')}
          >
            <div className="positions-modal-card__purchase-price">
              <Text
                size="xxxs"
                className="positions-modal-card__purchase-label"
              >
                {localize('Buy price:')}
              </Text>
              <Text
                weight="bold"
                size="xxs"
                className="positions-modal-card__purchase-value"
              >
            ...
            <div className="positions-modal-card__payout-price">
              ...
              <Text
                weight="bold"
                size="xxs"
                className="positions-modal-card__payout-value"
              >
          ...
          <div
            className={classNames('positions-modal-card__grid-price-payout')}
          >
            <div className="positions-modal-card__purchase-price">
              <Text
                size="xxxs"
              ...
              >
                <Money
                  amount={Number(contract_info.entry_spot)}
                  currency={currency}
                />
              </Text>
            </div>
            <div className="positions-modal-card__payout-price">
              ...
              >
                <Money
                  amount={Number(contract_info.barrier)}
                  currency={currency}
                />
              </Text>
            </div>
        ...
        <div className={classNames('positions-modal-card__item', className)}>
          <div className="dc-contract-card-item__header">
          ...
          >
            ...
            <div
              className={classNames('dc-contract-card__indicative--movement', {
                'dc-contract-card__indicative--movement-complete':
    ...
    const custom_card_header = (
      <ContractCard.Header
        ...
        getContractTypeDisplay={getContractTypeDisplay}
        has_progress_slider={
          (!is_mobile && has_progress_slider) || is_accumulator
        }
        is_mobile={is_mobile}
        is_sell_requested={is_sell_requested}
        onClickSell={onClickSell}
    ...
    return (
      <div
        ...
        className={classNames('positions-modal-card__wrapper', className)}
      >
        {is_unsupported ? (
          <div
