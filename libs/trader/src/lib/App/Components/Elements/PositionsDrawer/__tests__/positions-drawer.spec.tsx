...
const mocked_store = {
  ...
  portfolio: {
    all_positions: [] as TAllPositions,
    error: '',
...
jest.mock('@deriv/components', () => ({
  ...
  DataList: jest.fn((props) => (
    <div>{props.data_source.map(() => props.rowRenderer())}</div>
  )),
...
jest.mock('../../EmptyPortfolioMessage', () =>
  jest.fn(() => <div>{empty_portfolio_message}</div>)
);
    ...
    mocked_store.portfolio.all_positions = [
      {
        contract_info: mockContractInfo({
          ...
          contract_type: 'CALL',
          shortcode:
            'CALL_1HZ100V_10.00_1699697112_1699697772_S0P_2.33136_1699697111',
        }),
      },
    ] as TAllPositions;
    render(mockPositionsDrawer(mockStore(mocked_store)));
    ...
    mocked_store.portfolio.all_positions = [
      {
        contract_info: mockContractInfo({
          ...
          shortcode:
            'TURBOSLONG_1HZ100V_10.00_1699697112_1699697772_S0P_2.33136_1699697111',
        }),
      },
      {
        contract_info: mockContractInfo({
          ...
          shortcode:
            'TURBOSSHORT_1HZ100V_10.00_1699697112_1699697772_S0P_2.33136_1699697111',
        }),
      },
    ] as TAllPositions;
    render(mockPositionsDrawer(mockStore(mocked_store)));
    ...
    mocked_store.portfolio.all_positions = [
      {
        contract_info: mockContractInfo({
          ...
          shortcode:
            'VANILLALONGCALL_1HZ100V_10.00_1699697112_1699697772_S0P_2.33136_1699697111',
        }),
      },
      {
        contract_info: mockContractInfo({
          ...
          shortcode:
            'VANILLALONGPUT_1HZ100V_10.00_1699697112_1699697772_S0P_2.33136_1699697111',
        }),
      },
    ] as TAllPositions;
    render(mockPositionsDrawer(mockStore(mocked_store)));
