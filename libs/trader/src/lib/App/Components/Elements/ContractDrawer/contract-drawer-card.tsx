...
type TContractCardFooterProps = React.ComponentProps<
  typeof ContractCard.Footer
>;
type TSwipeableContractDrawerProps = React.ComponentProps<
  typeof SwipeableContractDrawer
>;
...
> &
  Pick<
    TContractCardFooterProps,
    'is_sell_requested' | 'onClickCancel' | 'onClickSell'
  > &
      ...
      >
        <div
          className={classNames('dc-contract-card', {
            ...
            'contract-card__market-closed--disabled':
              is_market_closed && should_hide_closed_overlay,
          })}
          ref={hover_ref}
        >
          {is_market_closed && !getEndTime(contract_info) && (
            <div
              className={classNames({
                'contract-card__market-closed--hidden':
                  isDesktop() && should_hide_closed_overlay,
              })}
            >
          ...
          >
            {has_swipeable_drawer && (
              <Collapsible.ArrowButton
                onClick={toggleContractAuditDrawer}
