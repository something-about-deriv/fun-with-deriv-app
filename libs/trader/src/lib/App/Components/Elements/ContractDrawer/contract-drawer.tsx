...
import ContractAudit from '../../../Components/Elements/ContractAudit';
...
const ContractDrawer = observer(
  ({
    ...
    const [should_show_contract_audit, setShouldShowContractAudit] =
      ...
      <React.Fragment>
        <ContractDrawerCard
          ...
          toggleContractAuditDrawer={() =>
            setShouldShowContractAudit(!should_show_contract_audit)
          }
        />
        ...
        <div
          ...
          className={classNames('contract-drawer', {
            ...
            'contract-drawer--is-multiplier-sold':
              is_multiplier && isMobile() && getEndTime(contract_info),
          })}
          style={{
      ...
      <React.Fragment>
        ...
        <MobileWrapper>
          ...
          >
            <Div100vhContainer
              height_offset="40px"
              is_bypassed={!contract_drawer_card_ref.current}
            >
              {contract_drawer}
            </Div100vhContainer>
          </div>
