...
import { filterByContractType } from '../Components/Elements/PositionsDrawer/helpers';
import TogglePositionsMobile from '../Components/Elements/TogglePositions/toggle-positions-mobile';
...
const PopulateHeader = observer(() => {
  ...
  const filtered_positions = positions.filter(
    (p) =>
      ...
      (isTurbosContract(trade_contract_type) ||
      isVanillaContract(trade_contract_type)
