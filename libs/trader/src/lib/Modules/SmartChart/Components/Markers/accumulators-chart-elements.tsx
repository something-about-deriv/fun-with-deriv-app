  ...
  > &
    Required<
      Pick<
        ...
        'underlying' | 'shortcode' | 'contract_id' | 'contract_type'
      >
    >;
};
...
type TAccumulatorsChartElements = {
  ...
  should_show_profit_text: React.ComponentProps<
    typeof AccumulatorsProfitLossTooltip
...
const AccumulatorsChartElements = ({
  ...
  const accumulators_positions = all_positions.filter(
    ({ contract_info }) =>
      ...
      filterByContractType(contract_info, 'accumulator')
  );
