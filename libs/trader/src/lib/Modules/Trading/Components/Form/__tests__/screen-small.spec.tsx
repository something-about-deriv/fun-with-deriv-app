...
jest.mock('@deriv/components', () => ({
  ...
  Collapsible: jest.fn(({ onClick, children }) => (
...
jest.mock('Modules/Contract/Components/AccumulatorsStats', () =>
  jest.fn(() => <div>AccumulatorsStats</div>)
);
jest.mock('Modules/Trading/Containers/contract-type', () =>
  jest.fn(() => <div>ContractType</div>)
);
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Multiplier/widgets',
  () => ({
    ...jest.requireActual(
      'Modules/Trading/Components/Form/TradeParams/Multiplier/widgets'
    ),
    AccumulatorOptionsWidget: jest.fn(() => (
      <div>AccumulatorOptionsWidget</div>
    )),
    MultiplierOptionsWidget: jest.fn(() => <div>MultiplierOptionsWidget</div>),
  })
);
jest.mock('Modules/Trading/Components/Form/TradeParams/trade-type-tabs', () =>
  jest.fn(() => <div>TradeTypeTabs</div>)
);
...
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Turbos/barrier-selector',
  () => jest.fn(() => <div>BarrierSelector</div>)
);
jest.mock('Modules/Trading/Components/Form/TradeParams/strike', () =>
  jest.fn(() => <div>Strike</div>)
);
...
jest.mock('Modules/Trading/Containers/allow-equals', () =>
  jest.fn(() => <div>AllowEqualsMobile</div>)
);
jest.mock(
  'Modules/Trading/Components/Elements/Multiplier/risk-management-info',
  () => jest.fn(() => <div>RiskManagementInfo</div>)
);
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Accumulator/accumulators-amount-mobile',
  () => jest.fn(() => <div>AccumulatorsAmountMobile</div>)
);
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Multiplier/take-profit',
  () => jest.fn(() => <div>TakeProfit</div>)
);
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Accumulator/accumulators-info-display',
...
jest.mock('Modules/Trading/Containers/purchase', () =>
  jest.fn(() => <div>Purchase</div>)
);

describe('<ScreenSmall />', () => {
  const mockScreenSmall = (
    mocked_store: TCoreStores,
    mocked_props: { is_trade_enabled: boolean }
  ) => {
    return (
  ...
  it('should render TradeParamsLoader if is_trade_enabled === false', () => {
    render(
      mockScreenSmall(mockStore(default_mock_store), {
  ...
  it('should call function setIsTradeParamsExpanded if MobileWidget was toggled', () => {
    ...
    expect(
      default_mock_store.modules.trade.setIsTradeParamsExpanded
    ).toBeCalled();
  });
