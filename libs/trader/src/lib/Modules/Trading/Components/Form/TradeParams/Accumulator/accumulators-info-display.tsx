...
const AccumulatorsInfoDisplay = observer(() => {
  ...
  const content = [
    ...
    },
    {
      ...
      value: `${maximum_ticks || 0} ${
        maximum_ticks === 1 ? localize('tick') : localize('ticks')
      }`,
      tooltip_text: localize(
  ...
  return (
    <Fieldset
      className={classNames('trade-container__fieldset', 'accu-info-display')}
    >
