...
const AmountWidget = ({
  ...
  const [is_expiration_modal_open, setIsExpirationModalOpen] =
  ...
  return (
    <React.Fragment>
      ...
      <button
        className="mobile-widget mobile-widget__multiplier"
        onClick={toggleModal}
      >
      ...
      {is_crypto_multiplier && (
        <button
          ...
          onClick={expiration ? toggleExpirationModal : undefined}
        >
...
export const MultiplierAmountWidget = observer(() => {
  const { amount, expiration, currency, is_crypto_multiplier } =
    useTraderStore();
    ...
    <React.Fragment>
      ...
      <button
        className={classNames(
          'mobile-widget mobile-widget__multiplier-options',
          {
...
export const AccumulatorOptionsWidget = observer(() => {
  const { growth_rate, has_open_accu_contract, tick_size_barrier } =
    useTraderStore();
