...
const MobileWidget = observer(() => {
  ...
  const getHumanReadableDuration = () => {
    ...
    const lookup = {
      t: [
        <Localize i18n_default_text="tick" key="t" />,
        <Localize i18n_default_text="ticks" key="ts" />,
      ],
      s: [
        <Localize i18n_default_text="second" key="s" />,
        <Localize i18n_default_text="seconds" key="ss" />,
      ],
      m: [
        <Localize i18n_default_text="min" key="m" />,
        <Localize i18n_default_text="mins" key="ms" />,
      ],
      h: [
        <Localize i18n_default_text="hour" key="h" />,
        <Localize i18n_default_text="hours" key="hs" />,
      ],
      d: [
        <Localize i18n_default_text="day" key="d" />,
        <Localize i18n_default_text="days" key="ds" />,
      ],
    };
  ...
  return (
    <div className="mobile-widget__wrapper">
      ...
      <TradeParamsModal
        is_open={is_open}
        toggleModal={() => toggleWidget(tab_index)}
        tab_index={tab_index}
      />
    </div>
  );
