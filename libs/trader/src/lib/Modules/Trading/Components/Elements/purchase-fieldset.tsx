...
const PurchaseFieldset = ({
  ...
  return (
    ...
    >
      <DesktopWrapper>
        <div
          className={classNames('trade-container__fieldset-wrapper', {
            'trade-container__fieldset-wrapper--disabled':
              is_proposal_error || is_disabled,
          })}
        >
          ...
          <div
            className={classNames('btn-purchase__shadow-wrapper', {
              'btn-purchase__shadow-wrapper--disabled':
                is_proposal_error || is_disabled,
            })}
            onMouseEnter={() => {
              if (!is_disabled) {
      ...
      <MobileWrapper>
        {is_proposal_error && (
          <div className="btn-purchase__error">{info.message}</div>
        )}
        {purchase_button}
      </MobileWrapper>
    </Fieldset>
