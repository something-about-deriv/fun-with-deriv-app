...
import {
  onChangeCancellationDuration,
  onToggleCancellation,
} from '../../../../../Stores/Modules/Trading/Helpers/multiplier';
import Fieldset from '../../../../..//App/Components/Form/fieldset';
import { TTradeStore } from '../../../../..//Types';
import { useTraderStore } from '../../../../../Stores/useTraderStores';
...
const CancelDeal = observer(
  ({
    ...
    const [is_deal_cancel_warning_visible, setDealCancelWarningVisibility] =
      React.useState(false);

    const canToggleDealCancel = () => {
      const should_show_popover =
        (has_take_profit || has_stop_loss) && should_show_cancellation_warning;
      if (should_show_popover)
        setDealCancelWarningVisibility(should_show_popover);
          ...
          {has_cancellation && (
            <React.Fragment>
              <RadioGroup
                ...
                onToggle={(event) =>
                  onChangeCancellationDuration({ event, onChangeMultiple })
                }
              >
