...
jest.mock('Modules/Trading/Components/Form/TradeParams/Duration', () =>
  jest.fn(() => <div>Duration</div>)
);
jest.mock('Modules/Trading/Components/Form/TradeParams/barrier', () =>
  jest.fn(() => <div>Barrier</div>)
);
jest.mock('Modules/Trading/Components/Form/TradeParams/last-digit', () =>
  jest.fn(() => <div>LastDigit</div>)
);
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Accumulator/accumulator',
...
jest.mock('Modules/Trading/Components/Form/TradeParams/amount', () =>
  jest.fn(() => <div>Amount</div>)
);
jest.mock(
...
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Multiplier/stop-loss',
  () => jest.fn(() => <div>StopLoss</div>)
);
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Multiplier/cancel-deal',
  () => jest.fn(() => <div>CancelDeal</div>)
);
jest.mock(
  'Modules/Trading/Components/Form/TradeParams/Multiplier/expiration',
...
describe('<TradeParams />', () => {
  ...
  it('should render Duration component inside of TradeParams if it is in the form_components array and do not render the rest components', () => {
    ...
    expect(
      screen.queryByText('AccumulatorsInfoDisplay')
