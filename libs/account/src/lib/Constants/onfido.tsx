...
export const getOnfidoPhrases = () => ({
  ...
  cross_device_checklist: {
    ...
    subtitle: (
      <Localize i18n_default_text="We're now ready to verify your identity" />
    ),
    title: <Localize i18n_default_text="Great, that's everything we need" />,
  },
  cross_device_error_desktop: {
    subtitle: (
      <Localize i18n_default_text="The link only works on mobile devices" />
    ),
    title: <Localize i18n_default_text="Something's gone wrong" />,
  },
  cross_device_error_restart: {
    subtitle: (
      <Localize i18n_default_text="You'll need to restart your verification on your computer" />
    ),
    title: <Localize i18n_default_text="Something's gone wrong" />,
  },
  cross_device_intro: {
    ...
    list_item_finish: (
      <Localize i18n_default_text="Check back here to finish the submission" />
    ),
    list_item_open_link: (
      <Localize i18n_default_text="Open the link and complete the tasks" />
    ),
    list_item_send_phone: (
      <Localize i18n_default_text="Send a secure link to your phone" />
    ),
  ...
  cross_device_return: {
    body: (
      <Localize i18n_default_text="Your computer may take a few seconds to update" />
    ),
    subtitle: (
      <Localize i18n_default_text="You can now return to your computer to continue" />
    ),
  ...
  doc_confirmation: {
    alert: {
      blur_detail: (
        <Localize i18n_default_text="Make sure everything is clear" />
      ),
      blur_title: <Localize i18n_default_text="Blurry photo detected" />,
      crop_detail: (
        <Localize i18n_default_text="Make sure full document is visible" />
      ),
      crop_title: <Localize i18n_default_text="Cut-off image detected" />,
      glare_detail: (
        <Localize i18n_default_text="Move away from direct light" />
      ),
      glare_title: <Localize i18n_default_text="Glare detected" />,
      no_doc_detail: (
        <Localize i18n_default_text="Make sure all of the document is in the photo" />
      ),
    ...
    body_image_medium: (
      <Localize i18n_default_text="It’ll take longer to verify you if we can’t read it" />
    ),
    body_image_poor: (
      <Localize i18n_default_text="To smoothly verify you, we need a better photo" />
    ),
    body_license: (
    ...
    body_tax_letter: (
      <Localize i18n_default_text="Make sure details are clear to read, with no blur or glare" />
    ),
    ...
    button_primary_upload_anyway: (
      <Localize i18n_default_text="Upload anyway" />
    ),
    button_secondary_redo: <Localize i18n_default_text="Redo" />,
    button_zoom: <Localize i18n_default_text="Enlarge image" />,
    image_accessibility: (
      <Localize i18n_default_text="Photo of your document" />
    ),
  ...
  doc_select: {
    ...
    extra_no_mobile: (
      <Localize i18n_default_text="Sorry, no mobile phone bills" />
    ),
    list_accessibility: (
      <Localize i18n_default_text="Documents you can use to verify your identity" />
    ),
  ...
  doc_submit: {
    button_link_upload: (
      <Localize i18n_default_text="or upload photo – no scans or photocopies" />
    ),
    ...
    title_id_front: (
      <Localize i18n_default_text="Submit identity card (front)" />
    ),
    title_license_back: <Localize i18n_default_text="Submit license (back)" />,
    title_license_front: (
      <Localize i18n_default_text="Submit license (front)" />
    ),
    title_passport: <Localize i18n_default_text="Submit passport photo page" />,
    title_permit_back: (
      <Localize i18n_default_text="Submit residence permit (back)" />
    ),
    title_permit_front: (
      <Localize i18n_default_text="Submit residence permit (front)" />
    ),
  },
  error_unsupported_browser: {
    subtitle_android: (
      <Localize i18n_default_text="Restart the process on the latest version of Google Chrome" />
    ),
    subtitle_ios: (
      <Localize i18n_default_text="Restart the process on the latest version of Safari" />
    ),
  ...
  generic: {
    accessibility: {
      close_sdk_screen: (
        <Localize i18n_default_text="Close identity verification screen" />
      ),
    ...
    errors: {
      interrupted_flow_error: {
        instruction: (
          <Localize i18n_default_text="Restart process on a different device" />
        ),
      ...
      invalid_type: {
        instruction: (
          <Localize i18n_default_text="Try using another file type." />
        ),
        message: <Localize i18n_default_text="File not uploaded." />,
      },
      lazy_loading: {
        message: (
          <Localize i18n_default_text="An error occurred while loading the component" />
        ),
      },
      multiple_faces: {
        instruction: (
          <Localize i18n_default_text="Only your face can be in the selfie" />
        ),
        message: <Localize i18n_default_text="Multiple faces found" />,
      },
      no_face: {
        instruction: (
          <Localize i18n_default_text="Your face is needed in the selfie" />
        ),
      ...
      sms_failed: {
        instruction: (
          <Localize i18n_default_text="Copy the link to your phone" />
        ),
      ...
      unsupported_file: {
        instruction: (
          <Localize i18n_default_text="Try using a JPG or PNG file" />
        ),
  ...
  get_link: {
    alert_wrong_number: (
      <Localize i18n_default_text="Check that your number is correct" />
    ),
    ...
    info_qr_how_list_item_camera: (
      <Localize i18n_default_text="Point your phone’s camera at the QR code" />
    ),
    ...
    number_field_input_placeholder: (
      <Localize i18n_default_text="Enter mobile number" />
    ),
    number_field_label: (
      <Localize i18n_default_text="Enter your mobile number:" />
    ),
    subtitle_qr: (
      <Localize i18n_default_text="Scan the QR code with your phone" />
    ),
    subtitle_sms: (
      <Localize i18n_default_text="Send this one-time link to your phone" />
    ),
    ...
    url_field_label: (
      <Localize i18n_default_text="Copy the link to your mobile browser" />
    ),
  },
  linked_computer: {
    button_primary: <Localize i18n_default_text="Continue" />,
    info: <Localize i18n_default_text="Make sure§" />,
    list_item_desktop_open: (
      <Localize i18n_default_text="2. Your desktop window stays open" />
    ),
    list_item_sent_by_you: (
      <Localize i18n_default_text="1. This link was sent by you" />
    ),
  ...
  mobilePhrases: {
    photo_upload: {
      body_id_back: (
        <Localize i18n_default_text="Take a photo of the back of your card" />
      ),
      body_id_front: (
        <Localize i18n_default_text="Take a photo of the front of your card" />
      ),
      body_license_back: (
        <Localize i18n_default_text="Take a photo of the back of your license" />
      ),
      body_license_front: (
        <Localize i18n_default_text="Take a photo of the front of your license" />
      ),
      body_passport: (
        <Localize i18n_default_text="Take a photo of your passport photo page" />
      ),
      body_selfie: (
        <Localize i18n_default_text="Take a selfie showing your face" />
      ),
    },
    selfie_capture: {
      alert: {
  ...
  permission_recovery: {
    ...
    list_header_cam: (
      <Localize i18n_default_text="Follow these steps to recover camera access:" />
    ),
    ...
    list_item_how_to_cam: (
      <Localize i18n_default_text="Grant access to your camera from your browser settings" />
    ),
    subtitle_cam: (
      <Localize i18n_default_text="Recover camera access to continue face verification" />
    ),
    title_cam: <Localize i18n_default_text="Camera access is denied" />,
  },
  permission: {
    body_cam: (
      <Localize i18n_default_text="We cannot verify you without using your camera" />
    ),
  ...
  photo_upload: {
    body_bank_statement: (
      <Localize i18n_default_text="Provide the whole document page for best results" />
    ),
    ...
    body_id_back: (
      <Localize i18n_default_text="Upload back of card from your computer" />
    ),
    body_id_front: (
      <Localize i18n_default_text="Upload front of card from your computer" />
    ),
    body_license_back: (
      <Localize i18n_default_text="Upload back of license from your computer" />
    ),
    body_license_front: (
      <Localize i18n_default_text="Upload front of license from your computer" />
    ),
    body_passport: (
      <Localize i18n_default_text="Upload passport photo page from your computer" />
    ),
    body_selfie: (
      <Localize i18n_default_text="Upload a selfie from your computer" />
    ),
    body_tax_letter: (
      <Localize i18n_default_text="Provide the whole document page for best results" />
    ),
  ...
  selfie_capture: {
    alert: {
      camera_inactive: {
        ...
        detail_no_fallback: (
          <Localize i18n_default_text="Make sure your device has a working camera" />
        ),
      ...
      camera_not_working: {
        ...
        detail_no_fallback: (
          <Localize i18n_default_text="Make sure your device's camera works" />
        ),
        title: <Localize i18n_default_text="Camera not working" />,
      },
      timeout: {
  ...
  selfie_confirmation: {
    ...
    subtitle: (
      <Localize i18n_default_text="Make sure your selfie clearly shows your face" />
    ),
  ...
  selfie_intro: {
    button_primary: <Localize i18n_default_text="Continue" />,
    list_accessibility: (
      <Localize i18n_default_text="Tips to take a good selfie" />
    ),
    list_item_face_forward: (
      <Localize i18n_default_text="Face forward and make sure your eyes are clearly visible" />
    ),
    list_item_no_glasses: (
      <Localize i18n_default_text="Remove your glasses, if necessary" />
    ),
    subtitle: (
      <Localize i18n_default_text="We'll compare it with your document" />
    ),
    title: <Localize i18n_default_text="Take a selfie" />,
  },
  sms_sent: {
    info: <Localize i18n_default_text="Tips" />,
    info_link_expire: (
      <Localize i18n_default_text="Your link will expire in one hour" />
    ),
    info_link_window: (
      <Localize i18n_default_text="Keep this window open while using your mobile" />
    ),
    link: <Localize i18n_default_text="Resend link" />,
    subtitle: (
      <Localize i18n_default_text="We've sent a secure link to %{number}" />
    ),
    subtitle_minutes: (
      <Localize i18n_default_text="It may take a few minutes to arrive" />
    ),
  ...
  switch_phone: {
    info: <Localize i18n_default_text="Tips" />,
    info_link_expire: (
      <Localize i18n_default_text="Your mobile link will expire in one hour" />
    ),
    ...
    subtitle: (
      <Localize i18n_default_text="Once you\'ve finished we'll take you to the next step" />
    ),
  ...
  upload_guide: {
    ...
    image_detail_blur_alt: (
      <Localize i18n_default_text="Example of a blurry document" />
    ),
    image_detail_blur_label: (
      <Localize i18n_default_text="All details must be clear — nothing blurry" />
    ),
    image_detail_cutoff_alt: (
      <Localize i18n_default_text="Example of a cut-off document" />
    ),
    image_detail_cutoff_label: (
      <Localize i18n_default_text="Show all details — including the bottom 2 lines" />
    ),
    image_detail_glare_alt: (
      <Localize i18n_default_text="Example of a document with glare" />
    ),
    image_detail_glare_label: (
      <Localize i18n_default_text="Move away from direct light — no glare" />
    ),
    image_detail_good_alt: <Localize i18n_default_text="Document example" />,
    image_detail_good_label: (
      <Localize i18n_default_text="The photo should clearly show your document" />
    ),
    subtitle: (
      <Localize i18n_default_text="Scans and photocopies are not accepted" />
    ),
