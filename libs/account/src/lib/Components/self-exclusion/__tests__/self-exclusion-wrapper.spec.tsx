...
describe('<SelfExclusionWrapper />', () => {
  ...
  it('should render SelfExclusionWrapper component without wrapper', () => {
    ...
    expect(screen.getByRole('section-self-exclusion-wrapper')).toHaveClass(
      'da-self-exclusion'
    );
    expect(screen.getByRole('section-self-exclusion-wrapper')).not.toHaveClass(
  ...
  it('should render SelfExclusionWrapper component with wrapper', () => {
    ...
    expect(screen.getByTestId('dt_div_100_vh')).toHaveClass(
      'da-self-exclusion__wrapper'
    );
    expect(screen.getByTestId('dt_themed_scrollbars')).toHaveClass(
      'da-self-exclusion__scrollbars'
    );
  });
  ...
  it('should render SelfExclusionWrapper mobile component with wrapper', () => {
    ...
    expect(screen.getByTestId('dt_div_100_vh')).not.toHaveClass(
      'da-self-exclusion__scrollbars'
    );
  });
});
