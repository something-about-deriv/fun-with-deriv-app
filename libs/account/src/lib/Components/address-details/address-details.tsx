...
const AddressDetails = observer(
  ({
    ...
    const [address_state_to_display, setAddressStateToDisplay] =
      React.useState('');
    ...
    const handleSubmitData = (
      values: TAddressDetailFormProps,
      actions: FormikHelpers<TAddressDetailFormProps>
    ) => {
    ...
    return (
      ...
      >
        {({
          ...
          FormikHelpers<TAddressDetailFormProps> &
          FormikState<TAddressDetailFormProps>) => (
          <AutoHeightWrapper
            default_height={350}
