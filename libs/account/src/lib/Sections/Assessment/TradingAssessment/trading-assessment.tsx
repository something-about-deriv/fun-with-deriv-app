...
import {
  ...
  TestWarningModal,
} from 'Components/trading-assessment';
...
const populateData = (form_data) => {
  return {
    ...
    trading_experience_financial_instruments:
      form_data.trading_experience_financial_instruments,
    trading_frequency_financial_instruments:
      form_data.trading_frequency_financial_instruments,
    ...
    leverage_trading_high_risk_stop_loss:
      form_data.leverage_trading_high_risk_stop_loss,
...
const TradingAssessment = observer(() => {
  ...
  const [should_show_warning_modal, setShouldShowWarningModal] =
    ...
    if (values.risk_tolerance === 'No') {
      ...
      const form_payload = {
        trading_experience_regulated: {
          ...
          leverage_trading_high_risk_stop_loss:
            values.leverage_trading_high_risk_stop_loss,
            ...
            <FormBody scroll_offset={isMobile() ? '150px' : '80px'}>
              ...
              {trading_assessment_questions().map((item) => {
                ...
                if (item.field_type === 'radio') {
                  return (
                    <fieldset
                      className="account-form__question"
                      key={form_control}
                    >
                      <DesktopWrapper>
                        <Text
