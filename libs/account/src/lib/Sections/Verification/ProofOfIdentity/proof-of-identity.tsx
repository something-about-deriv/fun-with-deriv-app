...
const ProofOfIdentity = ({ is_from_external, onStateChange }) => {
  ...
  React.useEffect(() => {
    const description_content =
      'Submit your proof of identity documents to verify your account and start trading';
    const title_content = 'Account Verification | Deriv app';

    const restoreMetaTagWithOGDescription = changeMetaTagWithOG(
      'description',
      description_content
    );
    const restoreMetaTagWithOGTitle = changeMetaTagWithOG(
      'title',
      title_content
    );
        ...
        <div ref={setRef} className="proof-of-identity">
          <div className="proof-of-identity__main-container">
            <ProofOfIdentityContainer
              ...
              setIsCfdPoiCompleted={undefined}
              getChangeableFields={undefined}
