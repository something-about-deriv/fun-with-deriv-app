...
const Reports = observer(({ history, location, routes }: TReports) => {
  ...
  React.useEffect(() => {
    ...
    toggleReports(true);
    return () => {
      setVisibilityRealityCheck(true);
      toggleReports(false);
      Analytics.trackEvent('ce_reports_form', {
        action: 'close',
        form_name: 'default',
        ...
        >
          <DesktopWrapper>
            <VerticalTab
              ...
              vertical_tab_index={
                selected_route.default ? 0 : reports_route_tab_index
              }
          ...
          <MobileWrapper>
            <Div100vhContainer
              className="reports__mobile-wrapper"
              height_offset="80px"
            >
              <SelectNative
              ...
              {selected_route?.component && (
                <selected_route.component
                  icon_component={selected_route.icon_component}
                />
              )}
            </Div100vhContainer>
          </MobileWrapper>
