...
const TwoMonthPickerLoadable = Loadable<
  TTwoMonthPickerLoadable,
  typeof TwoMonthPicker
>({
  loader: () =>
    import(/* webpackChunkName: "two-month-picker" */ './two-month-picker'),
  loading: () => null,
  render(loaded, props) {
...
const CompositeCalendar = observer((props: TCompositeCalendar) => {
  ...
  return (
    <React.Fragment>
      <DesktopWrapper>
        <div
          id="dt_composite_calendar_inputs"
