...
export type TColIndex =
  ...
  | ReturnType<
      typeof getMultiplierOpenPositionsColumnsTemplate
    >[number]['col_index'];
...
export type TSupportedContractType = keyof ReturnType<
  typeof getSupportedContracts
>;
export type TUnsupportedContractType = keyof ReturnType<
  typeof getUnsupportedContracts
>;
