...
export default class ErrorStore {
  ...
  setErrorMessage(
    ...
    const error_object = {
      ...
      is_show_full_page:
        is_show_full_page || /InvalidToken|WrongResponse/.test(error.code),
    ...
    this.is_self_exclusion_max_turnover_set =
      // @ts-expect-error fix this
      error_object?.is_self_exclusion_max_turnover_set;
    // @ts-expect-error fix this
    this.is_ask_authentication = error_object?.is_ask_authentication;
    this.is_ask_financial_risk_approval =
      // @ts-expect-error fix this
      error_object?.is_ask_financial_risk_approval;
  }
